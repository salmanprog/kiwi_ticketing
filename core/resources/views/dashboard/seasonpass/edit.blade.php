    ...
    <div class="padding">
        <div class="box">
            <div class="box-header dker">
                <h3><i class="material-icons">&#xe02e;</i> {{ __('Edit Season Pass') }}</h3>
                <small>
                    <a href="{{ route('adminHome') }}">{{ __('backend.home') }}</a> /
                    <a>{{$general_ticket['ticketSlug']}}</a> 
                </small>
            </div>
            <div class="box-tool">
                <ul class="nav">
            ...
            <div class="box-body p-a-2">
                {{Form::open(['route'=>['seasonpassUpdate',"id"=>$get_ticket->slug],'method'=>'POST', 'files' => true])}}
                {!! Form::hidden('ticketSlug', old('ticketSlug', $general_ticket['ticketSlug'] ?? ''), ['id' => 'ticketSlug']) !!}
                    <div class="form-group row">
                        <label for="title"
                                class="col-sm-2 form-control-label">{!!  __('Ticket') !!}
                        </label>
                        <div class="col-sm-10">
                            {!! Form::text('title', old('title', $general_ticket['ticketType'] ?? ''), [
                                'placeholder' => '',
                                'class' => 'form-control',
                                'id' => 'title',
                                'required' => '',
                                ...
                                @if($ActiveLanguage->box_status)
                                    <div class="m-b-1">
                                        ...
                                        <div class="box p-a-xs">
                                            {!! Form::textarea(
                                                'description',
                                                old('description', $get_ticket->description ?? ''),
                                                [
                                                    'ui-jp' => 'summernote',
                                                    'placeholder' => '',
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-10">
                            @if(isset($get_ticket->media_slider) && count($get_ticket->media_slider) > 0)
                                <div class="row">
                                    <div class="col-sm-12">
                                        @foreach($get_ticket->media_slider as $media)
                        ...
                        <div class="col-sm-10">
                            <div class="radio">
                                <label class="ui-check ui-check-md">
                                    <input id="is_parking_pass2" class="has-value"
                                            name="is_parking_pass" type="radio" value="0"
                                            {{ $get_ticket->is_parking_pass == 0 ? 'checked' : '' }}>
                                        <i class="dark-white"></i>
                                    No
                                </label>
                                &nbsp; &nbsp;
                                <label class="ui-check ui-check-md">
                                    <input id="is_parking_pass2" class="has-value" name="is_parking_pass" type="radio" value="1" {{ $get_ticket->is_parking_pass == 1 ? 'checked' : '' }}>
                                    <i class="dark-white"></i>
                                    Yes
                                </label>
                            </div>
