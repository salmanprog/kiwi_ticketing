    ...
    <div class="padding">
        <div class="box">
            ...
            <div class="box-body p-a-2">
                ...
                {!! Form::hidden('ticketSlug', old('ticketSlug', $get_ticket->slug ?? ''), ['id' => 'ticketSlug']) !!}
                    <div class="form-group row">
                        <label for="title"
                                class="col-sm-2 form-control-label">{!!  __('Title') !!}
                        </label>
                        <div class="col-sm-10">
                            {!! Form::text('title',old('title', $get_ticket->title ?? ''), array('placeholder' => '','class' => 'form-control','id'=>'title','required'=>'')) !!}
                        </div>
                    </div>
                    <div class="form-group row">
                        <label for="details"
