...
@section('content')
    <div class="padding">
        <div class="box">
            ...
            <div class="box-body" style="display: none;">
                ...
                <button type="button" class="btn btn-primary" id="openSeasonPassModal">
                    <i class="material-icons">&#xe02e;</i> {{ __('Create New Pass') }}
                </button>
            </div>
        </div>
    </div>
    ...
    <!-- Custom Modal -->
    <div class="custom-modal" id="seasonPassModal">
        <div class="custom-modal-content">
            <div class="custom-modal-header">
                <h5 class="modal-title">
                    <i class="material-icons">&#xe02e;</i> {{ __('Create New Pass') }}
                </h5>
                <button type="button" class="close-btn" id="closeSeasonPassModal"
            ...
            <div class="custom-modal-body">
                ...
                {{ Form::open(['route' => ['seasonpassStore'], 'method' => 'POST', 'files' => true, 'id' => 'multiStepForm']) }}
                ...
                <div class="form-navigation mt-4">
                    ...
                    <button type="submit" class="btn btn-success" id="submitBtn" style="display: none;">
                        <i class="material-icons">&#xe161;</i> {!! __('Create Pass') !!}
                    </button>
                </div>
...
@push('after-scripts')
    ...
    <script>
        ...
        document.addEventListener('DOMContentLoaded', function() {
            const modal = document.getElementById('seasonPassModal');
            const openBtn = document.getElementById('openSeasonPassModal');
            const closeBtn = document.getElementById('closeSeasonPassModal');
