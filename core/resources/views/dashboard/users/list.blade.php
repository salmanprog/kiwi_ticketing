                            ...
                            @foreach($Users as $User)
                                <tr class="user-row">
                                    ...
                                    <td class="permission-badge">
                                        <span class="badge badge-permission">{{ @$User->permissionsGroup->name}}</span>
                                    </td>
                                    <td class="text-center">
                                        <span class="status-indicator {{ ($User->status==1) ? 'active' : 'inactive' }}">
                                            <i class="material-icons">{{ ($User->status==1) ? "check_circle" : "cancel" }}</i>
                                    ...
                                    <td class="text-center action-buttons">
                                        <a class="btn btn-sm btn-success btn-action" 
                                           ...
                                           data-toggle="tooltip" title="{{ __('backend.edit') }}">
                                            <i class="material-icons">edit</i>
                                        </a>
                                        @if(@Auth::user()->permissionsGroup->settings_status)
                                            <button class="btn btn-sm btn-danger btn-action" 
                                                    data-toggle="modal"
                                                    data-target="#m-{{ $User->id }}" 
                            ...
                            <div class="bulk-actions-section">
                                ...
                                @if(@Auth::user()->permissionsGroup->settings_status)
                                    <div class="bulk-actions">
                                        ...
                                        <button id="submit_show_msg" class="btn btn-outline-primary" 
