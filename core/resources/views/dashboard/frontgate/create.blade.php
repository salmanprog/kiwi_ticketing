...
@section('title', __('Cabana Package'))
@push('after-styles')
    ...
    <div class="padding">
        <div class="box">
            <div class="box-header dker">
                <h3><i class="material-icons">&#xe02e;</i> {{ __('New Cabana Package') }}</h3>
                <small>
                    <a href="{{ route('adminHome') }}">{{ __('backend.home') }}</a> /
                    <a>{{__('cabana-package')}}</a> 
                </small>
            </div>
            <div class="box-tool">
                <ul class="nav">
            ...
            <div class="box-body p-a-2">
                {{Form::open(['route'=>['cabanaStore'],'method'=>'POST', 'files' => true])}}
                    <div class="form-group row">
                        <label for="section_id" class="col-sm-2 form-control-label">
                            {!! __('Cabanas') !!}
                        </label>
                        <div class="col-sm-10">
                            <select name="cabanas" class="form-control">
                                <option value="">- - {!!  __('Select Cabana') !!} - -</option>
...
@section('content')
    <div class="padding">
        <div class="box">
            ...
            <div class="box-body" style="display: none;">
                ...
                <button type="button" class="btn btn-primary" id="openCabanaModal">
                    <i class="material-icons">&#xe02e;</i> {{ __('Create New Cabana Package') }}
                </button>
            </div>
        </div>
    </div>
    ...
    <!-- Custom Modal -->
    <div class="custom-modal" id="cabanaModal">
        <div class="custom-modal-content">
            <div class="custom-modal-header">
                <h5 class="modal-title">
                    <i class="material-icons">&#xe02e;</i> {{ __('Create New Cabana Package') }}
                </h5>
                <button type="button" class="close-btn" id="closeCabanaModal"
            ...
            <div class="custom-modal-body">
                ...
                {{ Form::open(['route' => ['cabanaStore'], 'method' => 'POST', 'files' => true, 'id' => 'multiStepForm']) }}

                <!-- Step 1: Cabana Selection -->
                <div class="step active" id="step1">
                    <div class="form-group row">
                        ...
                        <div class="col-sm-9">
                            <select name="cabanas" class="form-control" required>
                                <option value="">- - {!! __('Select Cabana') !!} - -</option>
                                @foreach ($cabanas as $cabana)
                                    <option value="{{ $cabana['ticketSlug'] }}">
                                        {!! $cabana['ticketType'] !!}
                            ...
                            <div class="invalid-feedback">Please select a cabana</div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="form-group row mb-3">
                        ...
                        <div class="col-sm-9">
                            <div class="form-check form-check-inline">
                                <input class="form-check-input" type="radio" name="is_featured" id="is_featured1"
                                    value="1" checked>
                                <label class="form-check-label" for="is_featured1">Yes</label>
                            </div>
                            <div class="form-check form-check-inline">
                                <input class="form-check-input" type="radio" name="is_featured" id="is_featured2"
                                    value="0">
...
@push('after-scripts')
    ...
    <script>
        ...
        document.addEventListener('DOMContentLoaded', function() {
            ...
            const openBtn = document.getElementById('openCabanaModal');
            const closeBtn = document.getElementById('closeCabanaModal');
