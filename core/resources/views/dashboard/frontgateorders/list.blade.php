...
@section('title', __('Front Gate Orders'))
@section('content')
<style>
...
<div class="box">
    ...
    <div>
        <div class="table-responsive">
            @include("dashboard.frontgateorders.search")
                <table class="table table-bordered m-a-0" id="front_gate_orders">
                    <thead class="dker">
                    <tr>
...
<script src="{{ asset('assets/dashboard/js/datatables/datatables.min.js') }}"></script>
    <script type="text/javascript">
        ...
        $(document).ready(function () {
            var dataTable = $("#front_gate_orders").DataTable({
                processing: true,
                serverSide: true,
                searching: true,
                ajax: {
           ...
           $('#offer_orders').on('xhr.dt', function (e, settings, json, xhr) {
