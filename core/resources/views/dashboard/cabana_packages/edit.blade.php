    ...
    <div class="padding">
        <div class="box">
            <div class="box-header dker">
                <h3><i class="material-icons">&#xe02e;</i> {{ __('Edit Cabana') }}</h3>
                <small>
                    <a href="{{ route('adminHome') }}">{{ __('backend.home') }}</a> /
                    <a>{{__('cabanaPackage->ticketSlug')}}</a> 
                </small>
            </div>
            <div class="box-tool">
                <ul class="nav">
            ...
            <div class="box-body p-a-2">
                {{Form::open(['route'=>['cabanaUpdate',"id"=>$cabanaPackage->slug],'method'=>'POST', 'files' => true])}}
                    <div class="form-group row">
                            <label for="section_id" class="col-sm-2 form-control-label">
                                {!! __('Cabanas') !!}
                            </label>
                            <div class="col-sm-10">
                                {!! Form::text('cabanas',old('cabanas', $cabanaPackage->ticketType ?? ''), array('placeholder' => '','class' => 'form-control','id'=>'cabanas','required'=>'','readonly'=>'readonly')) !!}
                            </div>
                    </div>
                    <div class="form-group row">
                        <label for="details"
                                ...
                                @if($ActiveLanguage->box_status)
                                    <div class="m-b-1">
                                        ...
                                        <div class="box p-a-xs">
                                            {!! Form::textarea(
                                                'description',
                                                old('description', $cabanaPackage->description ?? ''),
                                                [
                                                    'ui-jp' => 'summernote',
                                                    'placeholder' => '',
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-10">
                            @if(count($cabanaPackage->media_slider) > 0)
                                <div class="row">
                                    <div class="col-sm-12">
                                        @foreach($cabanaPackage->media_slider as $media)
                        ...
                        <div class="col-sm-10">
                            <div class="radio">
                                <label class="ui-check ui-check-md">
                                    {!! Form::radio('is_featured','1',($cabanaPackage->is_featured==1) ? true : false, array('id' => 'is_featured1','class'=>'has-value')) !!}
                                    <i class="dark-white"></i>
                                    {{ __('backend.yes') }}
                                </label>
                                &nbsp; &nbsp;
                                <label class="ui-check ui-check-md">
                                    {!! Form::radio('is_featured','0',($cabanaPackage->is_featured==0) ? true : false, array('id' => 'is_featured2','class'=>'has-value')) !!}
                                    <i class="dark-white"></i>
                                    {{ __('backend.no') }}
                                </label>
                            </div>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-10">
                            <div class="radio">
                                <label class="ui-check ui-check-md">
                                    {!! Form::radio('status','1',($cabanaPackage->status==1) ? true : false, array('id' => 'status1','class'=>'has-value')) !!}
                                    <i class="dark-white"></i>
                                    {{ __('backend.active') }}
                                </label>
                                &nbsp; &nbsp;
                                <label class="ui-check ui-check-md">
                                    {!! Form::radio('status','0',($cabanaPackage->status==0) ? true : false, array('id' => 'status2','class'=>'has-value')) !!}
                                    <i class="dark-white"></i>
