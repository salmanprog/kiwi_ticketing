    ...
    <div class="custom-modal" id="offerModal">
        <div class="custom-modal-content">
            ...
            <div class="custom-modal-body">
                ...
                {{ Form::open(['route' => ['offercreationpackagesStore'], 'method' => 'POST', 'files' => true, 'id' => 'multiStepForm']) }}
                            ...
                            @foreach (Helper::languagesList() as $ActiveLanguage)
                                @if ($ActiveLanguage->box_status)
                                    <div class="mb-3">
                                        ...
                                        <div class="box p-a-xs">
                                            <textarea name="description_{{ $ActiveLanguage->code }}" class="form-control summernote_{{ $ActiveLanguage->code }}"
                ...
                <div class="form-navigation mt-4">
                    ...
                    <button type="submit" class="btn btn-success" id="submitBtn" style="display: none;">
                        <i class="material-icons">&#xe161;</i> {!! __('Create Offer') !!}
                    </button>
                </div>
