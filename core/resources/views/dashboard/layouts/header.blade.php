<div class="app-header white box-shadow navbar-md"
    style="background: #ffffff; border-bottom: 1px solid  #dee2e6; box-shadow: none">
    <div class="navbar">
        ...
        <div class="col-md-4 text-right" style="padding: 20px ;" >
            <div class="metric-badge"
                style="display: inline-block; color: #ffffff; padding: 6px 12px; border-radius: 8px; font-size: 15px; font-weight: 500; background: #A0C242; margin-right: 15px">
                <i class="far fa-calendar me-1" style="margin-right: 5px">
                </i>{{ now()->format('M j, Y') }}
            </div>
            ...
            <ul class="nav navbar-nav pull-right">
                ...
                @if ($alerts > 0)
                    <li class="nav-item dropdown pos-stc-xs">
                        <a class="nav-link text-dark" data-toggle="dropdown" style="position: relative;">
                            ...
                            @if ($alerts > 0)
                                <span class="label label-sm up warn"
                                    style="background: #A0C242; border: 2px solid white; position: absolute; top: -5px; right: -5px;">{{ $alerts }}</span>
                            @endif
                        </a>
                        <div class="dropdown-menu pull-right w-xl animated fadeInUp no-bg no-border no-shadow"
                            style="border: 1px solid #e9ecef !important; border-radius: 10px;">
                            <div class="box" style="background: white;">
                                <div class="box p-a scrollable maxHeight320">
                                    <div class="dropdown-header bg-light" style="border-radius: 10px 10px 0 0;">
                                        <h6 class="mb-0 text-dark"><i
                                                class="material-icons mr-2">&#xe7f5;</i>Notifications
                                        </h6>
                                    </div>
                                        ...
                                        @foreach ($webmailsAlerts as $webmailsAlert)
                                            <li class="list-group-item lt box-shadow-z0 b">
                                                <span class="clear block">
                                                    <small
                                                        class="text-muted">{{ $webmailsAlert->from_name }}</small><br>
                ...
                <li class="nav-item dropdown">
                    <a class=" clear text-dark" data-toggle="dropdown">
                    ...
                    <div class="dropdown-menu pull-right dropdown-menu-scale"
                        style="border: 1px solid #e9ecef; border-radius: 10px;">
                        <div class="dropdown-header bg-light" style="border-radius: 10px 10px 0 0;">
...
<a class="dropdown-item d-flex align-items-center"
                                        ...
                                        <i class="material-icons mr-2 text-muted">&#xe0be;</i>
                                        <span>{{ __('backend.compose') }}</span></a>
@endif
@endif
                            </div>
                        </li>
                ...
                <ul class="nav navbar-nav">
                    <li class="nav-item">
                        <div class="pa-13">
                            ...
                            <a href="{{ route('webmasterSettings') }}?tab=license" class="btn btn-danger"
                                style="border-radius: 20px;">{{ __('backend.licenseNow') }}</a>
                        </div>
                    </li>
                </ul>
            @endif
