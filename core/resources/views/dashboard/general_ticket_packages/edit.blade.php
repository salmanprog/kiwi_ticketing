    ...
    <div class="padding">
        <div class="box">
            <div class="box-header dker">
                <h3><i class="material-icons">&#xe02e;</i> {{ __('Edit General Package') }}</h3>
                <small>
                    <a href="{{ route('adminHome') }}">{{ __('backend.home') }}</a> /
                    <a>{{$general_ticket_packages->slug}}</a> 
                </small>
            </div>
            <div class="box-tool">
                <ul class="nav">
            ...
            <div class="box-body p-a-2">
                {{Form::open(['route'=>['generalticketpackagesUpdate',"id"=>$general_ticket_packages->slug],'method'=>'POST', 'files' => true])}}
                    <div class="form-group row">
                        <label for="title"
                                class="col-sm-2 form-control-label">{!!  __('Title') !!}
                        </label>
                        <div class="col-sm-10">
                            {!! Form::text('title',old('title', $general_ticket_packages->title ?? ''), array('placeholder' => '','class' => 'form-control','id'=>'title','required'=>'')) !!}
                        </div>
                    </div>
                    <div class="form-group row">
                        <label for="details"
                                ...
                                @if($ActiveLanguage->box_status)
                                    <div class="m-b-1">
                                        ...
                                        <div class="box p-a-xs">
                                            {!! Form::textarea(
                                                'description',
                                                old('description', $general_ticket_packages->description ?? ''),
                                                [
                                                    'ui-jp' => 'summernote',
                                                    'placeholder' => '',
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-10">
                            @if(count($general_ticket_packages->media_slider) > 0)
                                <div class="row">
                                    <div class="col-sm-12">
                                        @foreach($general_ticket_packages->media_slider as $media)
