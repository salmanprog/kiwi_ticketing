...
<div class="box">
    <div class="box-header dker">
        <h3>{{ __('General Packages') }}</h3>
        <small>
            <a href="{{ route('adminHome') }}">{{ __('backend.home') }}</a> /
            <a href="">{{ __('general-packages') }}</a>
        </small>
    </div>
     <div class="row p-a pull-right" style="margin-top: -70px;">
        <div class="col-sm-12">
            <a class="btn btn-fw primary" href="{{route('generalticketpackagesCreate')}}">
                        ...
                        <tbody>
                            ...
                            @foreach ($paginated as $packages)
                             <tr>
                                ...
                                <td>
                                   <div class="">
                                        <a href="{{ route('generalticketpackagesEdit',$packages['slug']) }}"> 
                                            {{ $packages['title'] }}
                                        </a>
                                    </div>
                                </td>
                                   ...
                                   <div class="dropdown">
                                        ...
                                        <div class="dropdown-menu pull-right">
                                            <a class="dropdown-item"
                                                href="{{ route('generalticketpackagesEdit',$packages['slug']) }}"><i
