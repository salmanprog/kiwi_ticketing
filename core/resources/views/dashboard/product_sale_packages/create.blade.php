    ...
    <div class="padding">
        <div class="box">
            <div class="box-header dker">
                <h3><i class="material-icons">&#xe02e;</i> {{ __('New Product Sale') }}</h3>
                <small>
                    <a href="{{ route('adminHome') }}">{{ __('backend.home') }}</a> /
                    <a>{{__('new-product-sale')}}</a> 
                </small>
            </div>
            <div class="box-tool">
                <ul class="nav">
...
@section('content')
        ...
        <div class="box">
            ...
            <div class="box-body" style="display: none;">
                ...
                <button type="button" class="btn btn-primary" id="openOfferModal">
                    <i class="material-icons">&#xe02e;</i> {{ __('Create New Product Sale') }}
                </button>
            </div>
        </div>
    </div>
    ...
    <!-- Custom Modal -->
    <div class="custom-modal" id="offerModal">
        <div class="custom-modal-content">
            ...
            <div class="custom-modal-body">
                ...
                {{ Form::open(['route' => ['productsalecreationpackagesStore'], 'method' => 'POST', 'files' => true, 'id' => 'multiStepForm']) }}

                <!-- Step 1: Basic Information -->
                <div class="step active" id="step1">
                    <div class="form-group row mb-3">
                        <label for="offerType" class="col-sm-3 form-control-label">
                        ...
                        <div class="col-sm-9">
                            ...
                            <div class="invalid-feedback">Please select offer type</div>
                        </div>
                    </div>
                    <div class="form-group row">
                        ...
                        <div class="col-sm-9">
                            <input type="text" name="title" placeholder="Enter offer title" class="form-control"
                                id="title" required>
                            ...
                            @foreach (Helper::languagesList() as $ActiveLanguage)
                                @if ($ActiveLanguage->box_status)
                                    <div class="mb-3">
                                        ...
                                        <div class="box p-a-xs">
                                            <textarea name="description" class="form-control summernote_{{ $ActiveLanguage->code }}"
                                                dir="{{ $ActiveLanguage->direction }}" rows="5"
                ...
                <div class="step" id="step3">
                    <div class="form-group row mb-3">
                        <label for="from_date" class="col-sm-3 form-control-label">{!! __('Start Date') !!}</label>
                        <div class="col-sm-9">
                            <input type="text" name="from_date" placeholder="Select start date"
                                class="form-control datepicker" id="from_date">
                        </div>
                    </div>
                    <div class="form-group row">
                        <label for="to_date" class="col-sm-3 form-control-label">{!! __('End Date') !!}</label>
                        <div class="col-sm-9">
                            <input type="text" name="to_date" placeholder="Select end date"
                ...
                <div class="form-navigation mt-4">
                    ...
                    <button type="submit" class="btn btn-success" id="submitBtn" style="display: none;">
                        <i class="material-icons">&#xe161;</i> {!! __('Create Product Sale') !!}
                    </button>
                </div>
    ...
    <script>
        ...
        document.addEventListener('DOMContentLoaded', function() {
            ...
            if (typeof jQuery !== 'undefined') {
                ...
                console.log('jQuery not available, using native date inputs');
