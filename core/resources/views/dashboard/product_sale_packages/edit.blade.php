    ...
    <div class="padding">
        <div class="box">
            <div class="box-header dker">
                <h3><i class="material-icons">&#xe02e;</i> {{ __('Edit Product Sale') }}</h3>
                <small>
            ...
            <div class="box-body p-a-2">
                {{Form::open(['route'=>['productsalecreationpackagesUpdate',"id"=>$offer_creation_packages->slug],'method'=>'POST', 'files' => true])}}
