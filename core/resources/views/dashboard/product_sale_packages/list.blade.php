...
<div class="box">
    <div class="box-header dker">
        ...
        <small>
            ...
            <a href="">{{ __('Product Sale') }}</a>
        </small>
    </div>
     <div class="row p-a pull-right" style="margin-top: -70px;">
        <div class="col-sm-12">
            <a class="btn btn-fw primary" href="{{route('productsalecreationpackagesCreate')}}">
                <i class="material-icons">&#xe7fe;</i>
                &nbsp; {{ __('Add New Product Sale') }}
            </a>
        </div>
    </div>
...
<script src="{{ asset('assets/dashboard/js/datatables/datatables.min.js') }}"></script>
    <script type="text/javascript">
        ...
        $(document).ready(function () {
            var dataTable = $("#product_sale_packages").DataTable({
                processing: true,
                serverSide: true,
                searching: true,
                ajax: {
                    url: "{{ route('productsalecreationpackages.data') }}",
                    type: "POST",
                    data: function (data) {
