    ...
    <div class="box-header dker">
     ...
     <div class="row p-a pull-right" style="margin-top: -70px;">
        ...
        <div class="table-responsive">
                    <table class="table table-bordered m-a-0" id="offer_addon">
                        <thead class="dker">
                        <tr>
                            <th>{{ __('venueId') }}</th>
                            <th>{{ __('Offer') }}</th>
...
<script src="{{ asset('assets/dashboard/js/datatables/datatables.min.js') }}"></script>
    <script type="text/javascript">
        ...
        function DeleteTicketAddon(id) {
            let url = '{{ route("offeraddonDestroy", ":id") }}';
        ...
        $(document).ready(function () {
            var dataTable = $("#offer_addon").DataTable({
                processing: true,
                serverSide: true,
                searching: true,
                ajax: {
                    url: "{{ route('offeraddon.data') }}",
                    type: "POST",
                    data: function (data) {
               ...
               dom: '<"row"<"col-sm-6"f><"col-sm-6"l>>rtip',
                ...
                initComplete: function () {
                    ...
                    var $searchInput = $('#offer_addon_filter input');
