            ...
            <div class="box-body p-a-2">
                {{Form::open(['route'=>['generalticketsaddonUpdate',"id"=>$ticket_addon->slug],'method'=>'POST', 'files' => true])}}
                                ...
                                @if($ActiveLanguage->box_status)
                                    <div class="m-b-1">
                                        ...
                                        <div class="box p-a-xs">
                                            {!! Form::textarea(
                                                'description',
                                                old('description', $ticket_addon->description ?? ''),
                                                [
                                                    'ui-jp' => 'summernote',
                                                    'placeholder' => '',
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-10">
                            @if(count($ticket_addon->media_slider) > 0)
                                <div class="row">
                                    <div class="col-sm-12">
                                        @foreach($ticket_addon->media_slider as $media)
                        ...
                        <div class="col-sm-10">
                            <div class="radio">
                                <label class="ui-check ui-check-md">
                                    {!! Form::radio('is_new_price_show','1',($ticket_addon->is_new_price_show==1) ? true : false, array('id' => 'is_new_price_show1','class'=>'has-value')) !!}
                                    <i class="dark-white"></i>
                                    {{ __('backend.yes') }}
                                </label>
                                &nbsp; &nbsp;
                                <label class="ui-check ui-check-md">
                                    {!! Form::radio('is_new_price_show','0',($ticket_addon->is_new_price_show==0) ? true : false, array('id' => 'is_new_price_show2','class'=>'has-value')) !!}
                                    <i class="dark-white"></i>
                                    {{ __('backend.no') }}
                                </label>
                            </div>
