        ...
        <div class="auth-form-section">
            ...
            <form name="form" method="POST" action="{{ url('/' . config('smartend.backend_path') . '/login') }}"
                ...
                <div class="form-group float-label {{ $errors->has('email') ? 'has-error' : '' }}">
                    <input type="email" name="email" value="{{ old('email') }}" class="form-input" placeholder=" "
                        required>
            ...
            <!-- Social Login Buttons -->
            <!-- @if (config('smartend.facebook_status') ||
                    config('smartend.twitter_status') ||
                    config('smartend.google_status') ||
                    config('smartend.linkedin_status') ||
                    config('smartend.github_status') ||
                    config('smartend.bitbucket_status'))
