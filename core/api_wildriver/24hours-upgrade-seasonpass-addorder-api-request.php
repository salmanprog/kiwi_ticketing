...
add_filter('gform_after_submission_37', 'change_form_37', 10, 3);
function change_form_37($form, $entry)
{
    ...
    $body = array(
        ...
        'purchases' => [
            array(
                ...
                'isTicketUpgraded' => 1,
                'ticketUpgradedNotes' => "Upgraded to Platinum Season Pass",
                    ...
                    <tr style="background-color: #fff;outline: 1px solid #cbcbcb;display: table;width: 100%;outline-offset: -1px;">
                        <td style="padding:20px">
                            ...
                            <table border="0" style="border: 1px solid #ececec;" width="100%">
                                ...
                                <p>
                                    <?php echo rgpost('input_42_1') . ' , ' . rgpost('input_42_2') . ' , ' . rgpost('input_42_3') ?>
                                    <?php echo rgpost('input_42_4') . ',' . rgpost('input_42_5'); ?>
                                </p>
                            </table>
...
add_filter('gform_confirmation_37', 'redirect_after_successful_stripe_payment_37', 10, 4);
function redirect_after_successful_stripe_payment_37($confirmation, $form, $entry, $ajax)
{
