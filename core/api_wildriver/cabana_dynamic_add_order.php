<?php
// Cabana Ticketing Sales
//add_filter( 'gform_authorizenet_transaction_pre_capture', 'change_form_20', 10, 3 );
add_filter('gform_after_submission_20', 'change_form_20', 10, 3);
function change_form_20($form)
{

    $iac_order_id = rgpost('input_1');
    $post_url = 'http://dev-dynamicpricing-env.eba-tkbnkmbm.us-east-1.elasticbeanstalk.com/Pricing/BirthdayPackageAddOrder';

    $total_price_dollar_remove = ltrim(rgpost('input_23'), '$');
    $BirthdayCake = ltrim(rgpost('input_38_2'), '$');
    $addonz2 = ltrim(rgpost('input_39_2'), '$');
    $addonz3 = ltrim(rgpost('input_41_2'), '$');
    $addonz4 = ltrim(rgpost('input_40_2'), '$');
    $addonz5 = ltrim(rgpost('input_42_2'), '$');
    $addonz6 = ltrim(rgpost('input_43_2'), '$');
    $addonz7 = ltrim(rgpost('input_44_2'), '$');
    $addonz8 = ltrim(rgpost('input_45_2'), '$');
    $addonz9 = ltrim(rgpost('input_46_2'), '$');
    $addonz10 = ltrim(rgpost('input_47_2'), '$');
    $addonz11 = ltrim(rgpost('input_48_2'), '$');
    $addonz12 = ltrim(rgpost('input_49_2'), '$');
    $addonz13 = ltrim(rgpost('input_50_2'), '$');
    $fruit_platter_sm = ltrim(rgpost('input_52_2'), '$');
    $fruit_platter_lg = ltrim(rgpost('input_53_2'), '$');
    // Removing (,) too
    $total_price_without_dollar = str_replace(',', '', $total_price_dollar_remove);

    //$tax_dollar_remove   = ltrim(rgpost('input_53'), '$');
    //$tax_without_dollar = str_replace(',', '', $tax_dollar_remove);

    //$service_dollar_remove   = ltrim(rgpost('input_54'), '$');
    ...
    curl_setopt_array($curl, array(
        ...
        "sessionId": "' . rgpost('input_18') . '",
        "orderId": "' . rgpost('input_17') . '",
            "customer": {
                "firstName": "' . rgpost('input_9') . '",
                "lastName": "' . rgpost('input_10') . '",
                "email": "' . rgpost('input_11') . '",
                "phone": "' . rgpost('input_12') . '"
            },
            "purchases": [
            {
                "ticketType": "' . rgpost('input_3') . '",
                "sectionId": "' . rgpost('input_19') . '",
                "capacityId": "' . rgpost('input_20') . '",
                "quantity": "' . rgpost('input_6') . '",
                "amount": "' . rgpost('input_25') . '"
            },
            {
                "ticketType": "Birthday Cake",
                "sectionId": "0",
                "capacityId": "' . rgpost('input_20') . '",
                "quantity": "' . rgpost('input_38_3') . '",
                "amount": "' . $BirthdayCake . '"
            },
            {
            ...
            {
                "ticketType": "Mini Corn Dog Platter",
                "sectionId": "0",
                "capacityId": "' . rgpost('input_20') . '",
            ...
            },
            {
                ...
                "sectionId": "0",
                "capacityId": "' . rgpost('input_20') . '",
                "quantity": "' . rgpost('input_53_3') . '",
                "amount": "' . $fruit_platter_lg . '"
            }
        ],
            "payment": {
                "cardholerName": "Omitted",
                "billingStreet": "' . rgpost('input_33_1') . ', ' . rgpost('input_33_2') . ', ' . rgpost('input_33_3') . ', ' . rgpost('input_33_4') . '",
                "billingZipCode": "' . rgpost('input_33_5') . '",
                "cvn": "Omitted",
                "expDate": "Omitted",
                "ccNumber": "Omitted",
                "paymentCode": "32",
    ...
    if ($response_body != '') { ?>
        ...
        <?php if ($response_body["status"]["errorCode"] != 0) {
            ...
            $to = 'design.turtles700@gmail.com, huzaifa@idreamtechnology.com';
            //$subject = 'Thank You For Purchasing - Your Order Number is #' . rgpost('input_26');
            $subject = 'Problem with Wild Rivers Order Number is #' . rgpost('input_17');
            ...
            <?php
            $payment_verify_url = 'https://staging13.tickets.wildrivers.com/wp-json/gravityForms/getPaymentStatus?order_id=' . rgpost('input_17');
            ...
            if (isset($payment_verify_response_body['error_code']) && $payment_verify_response_body['error_code'] === 0) {
                ...
                $post_url = 'http://dev-dynamicpricing-env.eba-tkbnkmbm.us-east-1.elasticbeanstalk.com/Pricing/QueryOrder2?orderId=' . rgpost('input_17') . '&authCode=d063d05b-fbb1-4bf0-b4d8-b2f603454858';
                    ...
                    <tr style="background-color: #173767;">
                        <td style="padding: 30px;">
                            <h1 style="color: #fff; text-align: center; font-weight: 400; font-size: 26px; margin: 0;">Thank You
                                For Purchasing - Your Order Number is #<?php echo rgpost('input_17'); ?></h1>
                        </td>
                    </tr>
                        ...
                        <td style="padding:20px">
                            <table border="0" width="100%" cellspacing="0" cellpadding="0" style="margin-bottom: 0;">
                                <tr>
                                    <td style="padding-bottom: 10px;">
                                        <p>
                                            Hi <?php echo rgpost('input_9'); ?>,<br />
                                            We've received your order #<?php echo rgpost('input_17'); ?>
                            ...
                            <table border="1" width="100%" cellspacing="0" cellpadding="0" bordercolor="#cbcbcb"
                                ...
                                <tr>
                                    <td style="padding:5px">
                                        Cabana - <?php echo rgpost('input_3'); ?> (<?php echo rgpost('input_5'); ?>)
                                    </td>
                                    <td style="padding:5px">
                                        <?php echo rgpost('input_6'); ?>
                                    </td>
                                ...
                                <tr>
                                    ...
                                    <td style="padding:5px"><?php echo rgpost('input_23'); ?></td>
                                </tr>
                                ...
                                <tr>
                                    <td style="padding:5px" colspan="3">
                                        ...
                                        <a href="https://staging13.tickets.wildrivers.com/update-order/?order=<?php echo rgpost('input_17'); ?>"
                            ...
                            <table border="0" style="border: 1px solid #ececec;" width="100%">
                                ...
                                <p>
                                    ...
                                    <?php echo rgpost('input_11'); ?> <br />
                                    <?php echo rgpost('input_12'); ?> <br />
                                    <?php echo rgpost('input_13'); ?> <br />
                                    <?php echo rgpost('input_14'); ?> - <?php echo rgpost('input_15'); ?> -
                                    <?php echo rgpost('input_16'); ?> <br />
                                </p>
                            </table>
                ...
                $to = rgpost('input_11');
                //$subject = 'Thank You For Purchasing - Your Order Number is #' . rgpost('input_26');
                $subject = 'Thank You For Purchasing - Your Wild Rivers Order Number is #' . rgpost('input_17') . ' for ' . rgpost('input_1');
